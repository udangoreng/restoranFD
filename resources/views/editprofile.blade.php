                ...
                <div class="profile-layout">
                    <aside class="profile-card">
                        <div class="profile-photo">
                            <img src="{{ Storage::disk('public')->exists($userdata->profile_img_path) ? asset('storage/'. $userdata->profile_img_path) : asset($userdata->profile_img_path) }}" alt="{{ $userdata->name }}" height="150px"
                                alt="Profile Photo">
                        </div>
