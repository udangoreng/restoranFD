            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="checkout-box">
                        <h1 class="page-title mb-4">Payment Pending</h1>
                        
                        <div class="mb-4">
                            <i class="fas fa-times-circle" style="font-size: 80px; color: #dc3545;"></i>
                        </div>
                        
                        <h3 class="mb-3">Still Waiting For Your Payment</h3>
                        
                        <p class="mb-4">
                            Your payment is still pending. Please Proceed Before Continue.
                        </p>
