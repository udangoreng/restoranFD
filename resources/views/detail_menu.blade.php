        ...
        <div class="row align-items-start detail-menu-box p-4">
            ...
            <div class="col-md-4 d-flex justify-content-center">
                <div class="detail-menu-image-circle">
                    <img src="{{ Storage::disk('public')->exists($img_path) ? asset('storage.'. $menu->img_path) : $menu->img_path }}" alt="Gambar Menu" class="detail-menu-image">
                </div>
            </div>
            ...
            <div class="row g-3">
                @foreach ($otherMenus as $item)
                    <div class="col-6 col-md-3">
                        <div class="othermenu-item" style="background-image: url({{ Storage::disk('public')->exists($img_path) ? asset('storage.'. $item->img_path) : $item->img_path }});"></div>
